...
if(isset($_POST['Valider1']))
		{
			...
			$requete="SELECT id FROM categories WHERE titre='$titre1'";
			$result=mysqli_query($base, $requete);
			$titre2=mysqli_fetch_array($result);

			$requete1='INSERT INTO `sous-categories` (`id`, `titre`, `id_categorie`) VALUES (NULL, "'.$_POST['field1'].'", "'.$titre2['id'].'" );';
	...
	$titre=$_POST['field1'];
	$requete1="SELECT titre from categories WHERE titre='$titre'";
	...
	{
	$requete='INSERT INTO `categories` (`id`, `titre`) VALUES (NULL, "'.$_POST['field1'].'");';
	...
	<?php
...
else if(isset($_POST['Valider3']))
		{
			...
			$requete="DELETE FROM `sous-categories` WHERE titre='$sous_categorie'";
			mysqli_query($base, $requete);
...
else if(isset($_POST['Valider4']))
		{
			...
			$requete3="DELETE FROM `sous-categories` WHERE id_categorie='$id'";
			mysqli_query($base, $requete3);

			$requete2="DELETE FROM `categories` WHERE titre='$categorie'";
...
<article class="formulaireajout">
	...
	<div class="optioncategorie">
		<div class="form-style-7">
			<form method="post" action="administration.php">
				<input type="submit" name="sous-categories" value="Ajouter Sous-catégorie">
			</form>
		</div>
		<div class="form-style-7">
			<form method="post" action="administration.php">
...
if(isset($_POST['sous-categories']))
{
$base = mysqli_connect("localhost", "root", "", "forum");
mysqli_set_charset($base, "utf8");
$requete="SELECT titre from categories";
...
$base = mysqli_connect("localhost", "root", "", "forum");
mysqli_set_charset($base, "utf8");
$requete="SELECT titre from 'sous-categories'";
$resultat=mysqli_query($base, $requete);
