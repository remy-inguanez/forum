...
$titre=$_SESSION['topics'];


$topic = "SELECT id FROM `sous-categories` WHERE titre='$titre'";
$result=mysqli_query($base, $topic);
$numtopic=mysqli_fetch_array($result);

$categorie = "SELECT id FROM `sous-categories`  WHERE titre ='$titre'";
...
$_GET['categories'] = $numcategorie['id'];
$_GET['topics'] = $numtopic['id'];
...
$sql = 'SELECT id, auteur, titre, date_derniere_reponse FROM forum_sujets WHERE correspondance_categorie="'.$_GET['categorie'].'" and topics="'.$_GET['topics'].'" ORDER BY date_derniere_reponse DESC';
...
<div class="newsujet">
	<a href="../insert_sujet.php/?categorie=<?php echo $_GET['categorie']; ?>/?topics=<?php echo $_GET['topics'];?>"><button class="ajoutsujet" >Insérer un sujet</button></a>
</div>
...
<div class="nomcategorie">
    ...
    <a id="h2" href=""><h2><?php echo $_SESSION['topics'];?></h2></a>
</div>
...
<div class="newsujet">
	<a href="../insert_sujet.php/?categorie=<?php echo substr($_GET['categorie'], 0, 1); ?>/?topics=<?php echo SUBSTR($_GET['categorie'],9, 1);?>"><button class="ajoutsujet" >Insérer un sujet</button></a>
</div>
