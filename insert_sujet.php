...
if(isset($_POST['go']))
{
		...
		$sql = "INSERT INTO `forum_sujets` (`auteur`, `date_derniere_reponse`, `titre`, `correspondance_categorie`, `topics`)  VALUES ('".$auteur."', CURRENT_TIMESTAMP(), '".$titre."','".$_POST['categorie']."','".$_POST['topics']."')";
